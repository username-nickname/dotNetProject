...
public class AssignSubjectTeacherDtoValidator : AbstractValidator<AssignSubjectTeacherDto>
{
    public AssignSubjectTeacherDtoValidator(ITeacherRepository teacherRepository, ISubjectRepository subjectRepository)
    {
        ...
        RuleFor(dto => dto)
            ...
            {
                bool alreadyAssigned = await teacherRepository.HasSubject(dto.TeacherId, dto.SubjectId);
                return !alreadyAssigned;
            })
            .WithMessage("Цей предмет уже призначено вчителю.");
    }
}